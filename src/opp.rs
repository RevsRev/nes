...
lazy_static! {
    ...
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x10, "BPL", 2, 2 /*+1 if branch succeeds, +2 if to a new page*/, AddressingMode::Implied),
        ...
        OpCode::new(0xC1, "CMP", 2, 5 /*+1 if page is crossed*/, AddressingMode::Indirect_Y),
        ...
        OpCode::new(0x78, "SID", 1, 2, AddressingMode::Implied),
